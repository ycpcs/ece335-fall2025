...
1.5.4 (pg. 56), 1.5.6 (pg. 56)

Ex. 2.1.3 1-3 (pg. 62), 2.1.1 (pg. 66) a,b,e, 2.1.4 (pg. 67)
...
> 
> 1.5.6 - Use a truth table for (a) to show the equivalence, and logical equivalence laws for (b) to manipulate one side into the other.
> 
