...
> 
> 5.1.11 - (a) Start by letting *x* be an arbitrary element of *A* and *b* = *f(x)*. Then use the fact that *S* is reflexive to deduce a fact about (*x*, *x*). (b) Start by letting *x*, *y* be arbitrary elements of *A* such that *a* = *f(x)* and *b* = *f(y)*. Use the fact that *S* is symmetric to deduce a fact about (*x*, *y*) and (*y*, *x*). (c) Start by letting *x*, *y*, *z* be arbitrary elements of *A* such that *a* = *f(x)*, *b* = *f(y)*, and *c* = *f(z)*. Use the fact that *S* is transitive to deduce a fact about (*x*, *y*), (*y*, *z*), and (*x*, *z*).
> 
